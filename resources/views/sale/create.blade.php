            ...
            <div class="bg-white overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 p-4 lg:space-y-0">
                  ...
                  <div class="pr-10 pl-10 pb-10 pt-3 text-xs text-gray-700 uppercase bg-white dark:bg-gray-700 dark:text-gray-400">
                    <form action="{{url('sale/create')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="grid grid-cols-3 gap-3">
                        ...
                        <div class="mb-6">
                            <label for="sale" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sale Code</label>
                            <input name="SaleCode" placeholder="Sale" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                          </div>
                      </div>
                      <div class="grid grid-cols-2 gap-2 mb-6">
                              <div class="md-6">
                          <label for="Qauntity" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qauntity</label>
                          <input type="text" placeholder="Qauntity" id="qty" name="SaleQty" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        </div>
                        <div class="md-6">
